<x-app-layout>
    ...
    <div class="min-h-screen bg-slate-100 py-8 px-6">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <form
                method="POST"
                action="{{ route('observer.pre.update', $response->responseID) }}">
                                        ...
                                        @foreach($section->criteria as $criteria)
                                            ...
                                            @php
                                                ...
                                                $savedScore = old(
                                                    ...
                                                    $existingScores[$criteria->criteriaID] ?? null
                                                );
                                            @endphp
                                                    ...
                                                    <td
                                                        ...
                                                        <textarea
                                                            ...
                                                            class="section-comment
                                                                ...
                                                                $existingComments[$section->sectionID] ?? ''
                                                            ) }}</textarea>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function highlightAchievementLevel(percentage) {
                ...
                if (percentage < 40) {
                    ...
                    selectedLevel =
                        document.getElementById('level-weak');
                    ...
                    selectedLevel =
                        document.getElementById('level-satisfactory');
                    ...
                    selectedLevel =
                        document.getElementById('level-good');
                    ...
                    selectedLevel =
                        document.getElementById('level-very-good');
                    ...
                    selectedLevel =
                        document.getElementById('level-excellent');
            ...
            // Calculate score and check form completion
            function updateForm() {
                ...
                maximumScoreElement.textContent =
                    maximumScore;
            ...
            // Listen for observation information
