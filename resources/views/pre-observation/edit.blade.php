<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="relative bg-gradient-to-br from-slate-900 via-violet-950 to-purple-900 rounded-3xl p-8 shadow-xl overflow-hidden mb-8">
                ...
                <div class="relative z-10 flex items-center justify-between gap-5">
                    ...
                    <div class="bg-white/10 border border-white/10 rounded-xl px-4 py-2 text-center flex-shrink-0">

                        <p class="text-xs text-violet-300 uppercase font-semibold">
                            Version
                        </p>
            ...
            <form method="POST" action="{{ route('observer.pre.update', $response->responseID) }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="class_name"
                                name="class_name"
                                value="{{ old('class_name', $response->class_name) }}"
                        ...
                        <div>
                            ...
                            <label for="subject_name" class="block text-sm font-semibold text-slate-700 mb-1.5">
                                Subject
                            </label>
                            ...
                            <input
                                ...
                                id="subject_name"
                                name="subject_name"
                                value="{{ old('subject_name', $response->subject_name) }}"
                                class="w-full rounded-xl border-slate-300 py-2 focus:border-purple-500 focus:ring-purple-500">
                        ...
                        <div>
                            ...
                            <label for="observation_date" class="block text-sm font-semibold text-slate-700 mb-1.5">
                                Date
                            </label>
                            ...
                            <input
                                ...
                                value="{{ old('observation_date', $response->observation_date) }}"
                                class="w-full rounded-xl border-slate-300 py-2 focus:border-purple-500 focus:ring-purple-500">
                        ...
                        <table class="w-full">
                                ...
                                @foreach($form->sections as $section)
                                    ...
                                    @if($section->criteria->isNotEmpty())
                                        ...
                                        <tr class="bg-blue-50">
                                            ...
                                            <td class="px-5 py-4 text-center text-sm font-bold text-slate-700">
                                                {{ $loop->iteration }}
                                            </td>

                                            <td colspan="3" class="px-5 py-4 text-sm font-bold text-slate-900">
                                        ...
                                        @foreach($section->criteria as $criteria)
                                            ...
                                            @php
                                                $letter = chr(96 + $loop->iteration);
                                                $savedScore = old('scores.' . $criteria->criteriaID, $existingScores[$criteria->criteriaID] ?? null);
                                            @endphp
                                            ...
                                            <tr class="hover:bg-slate-50 transition">
                                                        ...
                                                        @for($score = $form->min_score; $score <= $form->max_score; $score++)
                                                            ...
                                                            <label class="flex items-center gap-1.5 cursor-pointer">
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="{{ $score }}"
                                                                    {{ $savedScore == $score ? 'checked' : '' }}
                                                                    class="pre-score text-blue-600 border-slate-300 focus:ring-blue-500">
                                                ...
                                                @if($loop->first)
                                                    ...
                                                    <td
                                                        ...
                                                        class="px-5 py-5 align-middle border-l border-slate-100">

                                                        <textarea
                                                            name="section_comments[{{ $section->sectionID }}]"
                                                            rows="5"
                                                            placeholder="Enter comment..."
                                                            class="section-comment w-full rounded-xl border-slate-300 focus:border-purple-500 focus:ring-purple-500">{{ old('section_comments.' . $section->sectionID, $existingComments[$section->sectionID] ?? '') }}</textarea>
                            ...
                            <tfoot>
                                ...
                                <tr class="bg-blue-900 text-white">
                                    ...
                                    <td colspan="2" class="px-5 py-3 text-right text-sm font-bold uppercase">
                                        Total
                                    </td>

                                    <td class="px-5 py-3 text-center text-sm">

                                        <span id="totalScore" class="font-bold text-white">
                                            0
                                        </span>
                                    ...
                                    <td class="px-5 py-3 text-center text-sm">
                                        ...
                                        <span id="percentage" class="ml-2 font-bold text-white">
                                            0%
                                        </span>
                ...
                <div class="bg-white rounded-3xl shadow-lg p-6 mb-8">
                    ...
                    <textarea
                        ...
                        rows="4"
                        placeholder="Enter comment..."
                        class="w-full rounded-xl border-slate-300 focus:border-purple-500 focus:ring-purple-500">{{ old('other_comment', $response->other_comment) }}</textarea>
                ...
                <div class="bg-white rounded-3xl shadow-lg px-6 py-5 mb-8">
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
                            ...
                            <div id="level-weak" class="achievement-level bg-slate-50 border border-slate-200 rounded-xl px-5 py-3 text-center transition">
                                <p class="font-semibold text-slate-800">Weak</p>
                                <p class="text-sm text-slate-500 mt-1">0 - 39%</p>
                            </div>

                            <div id="level-satisfactory" class="achievement-level bg-slate-50 border border-slate-200 rounded-xl px-5 py-3 text-center transition">
                                <p class="font-semibold text-slate-800">Satisfactory</p>
                                <p class="text-sm text-slate-500 mt-1">40 - 59%</p>
                            </div>

                            <div id="level-good" class="achievement-level bg-slate-50 border border-slate-200 rounded-xl px-5 py-3 text-center transition">
                                <p class="font-semibold text-slate-800">Good</p>
                                <p class="text-sm text-slate-500 mt-1">60 - 79%</p>
                            </div>

                            <div id="level-very-good" class="achievement-level bg-slate-50 border border-slate-200 rounded-xl px-5 py-3 text-center transition">
                                <p class="font-semibold text-slate-800">Very Good</p>
                                <p class="text-sm text-slate-500 mt-1">80 - 89%</p>
                            </div>

                            <div id="level-excellent" class="achievement-level bg-slate-50 border border-slate-200 rounded-xl px-5 py-3 text-center transition">
                    ...
                    <div class="bg-white/95 backdrop-blur-sm border border-slate-200 shadow-xl rounded-2xl px-6 py-4">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            ...
                            <div class="flex items-center gap-3 flex-shrink-0">
                                ...
                                <a
                                    href="{{ route('observer.manage', $gn_id) }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const maxScore = Number(maximumScoreElement.dataset.maxScore);

            function resetAchievementLevels() {

                document.querySelectorAll('.achievement-level').forEach(function(level) {
            ...
            function updateForm() {
                ...
                const selectedScores = document.querySelectorAll('.pre-score:checked');
                ...
                const maximumScore = totalCriteria * maxScore;
