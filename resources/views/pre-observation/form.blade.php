<x-app-layout>
    ...
    <div class="min-h-screen bg-slate-100 py-8 px-6">
        <div class="max-w-7xl mx-auto">
            ...
            <form method="POST" action="{{ route('observer.pre.store', $gn_id) }}">
                @csrf
                                                        ...
                                                        @for($score = $form->min_score; $score <= $form->max_score; $score++)
                                                            ...
                                                            <label class="flex items-center gap-1.5 cursor-pointer">
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="{{ $score }}"
                                                                    {{ old('scores.' . $criteria->criteriaID) == $score ? 'checked' : '' }}
                                                ...
                                                @if($loop->first)
                                                    ...
                                                    <td
                                                        ...
                                                        <textarea
                                                            ...
                                                            class="section-comment w-full rounded-xl border-slate-300 focus:border-purple-500 focus:ring-purple-500">{{ old('section_comments.' . $section->sectionID) }}</textarea>
                ...
                <div class="bg-white rounded-3xl shadow-lg p-6 mb-8">
                    ...
                    <textarea
                        ...
                        rows="4"
                        placeholder="Enter comment..."
                        class="w-full rounded-xl border-slate-300 focus:border-purple-500 focus:ring-purple-500">{{ old('other_comment') }}</textarea>
                ...
                <div class="bg-white rounded-3xl shadow-lg px-6 py-5 mb-8">
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
                            ...
                            <div
                                id="level-weak"
                                class="achievement-level bg-slate-50 border border-slate-200 rounded-xl px-5 py-3 text-center">
