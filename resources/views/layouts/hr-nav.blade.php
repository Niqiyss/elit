    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="flex justify-between h-20 items-center">
            ...
            <div class="hidden sm:flex items-center space-x-10">
                ...
                <a href="{{ route('hr.gurunew.create') }}"
                    class="text-lg font-semibold text-gray-700 hover:text-purple-700 transition">
                    Register 
                </a>


                <a href="{{ route('hr.gurunew.index') }}"
                    class="text-lg font-semibold text-gray-700 hover:text-purple-700 transition">
                    List Teacher
                </a>
                ...
                <form method="POST"
                    ...
                    <button type="submit"
                        class="flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-xl font-semibold shadow transition">
