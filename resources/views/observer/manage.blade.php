                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <p class="text-xs font-semibold uppercase
                                      tracking-wider text-violet-300 mb-1">
                                Teacher
                            </p>
                                    ...
                                    <td class="px-8 py-6 text-center">
                                        ...
                                        @elseif($preResponse->status === 'Draft')
                                            ...
                                            <a
                                                href="{{ route(
                                                    'observer.pre.edit',
                                                    $preResponse->responseID
                                                ) }}"
                                                class="inline-flex items-center justify-center
                                                       px-4 py-2
                                                       bg-yellow-200 hover:bg-yellow-300
                                                       text-yellow-700 rounded-xl
                                                       font-semibold transition">
                                                Edit
                                            </a>
                                    ...
                                    <td class="px-8 py-6">
                                        ...
                                        @if($latestExternalResponse)
                                            <p class="text-xs text-slate-400 mt-1">
                                                Attempt {{ $latestExternalResponse->attempt_no }}
                                            </p>
                                        @endif
                                    ...
                                    <td class="px-8 py-6 text-center">
                                        ...
                                        @elseif($latestExternalResponse->status === 'Draft')
                                            ...
                                            <a
                                                href="{{ route(
                                                    'external.pdpc.edit',
                                                    $latestExternalResponse->responseID
                                                ) }}"
                                                class="inline-flex items-center justify-center
                                                       px-4 py-2
                                                       bg-yellow-200 hover:bg-yellow-300
