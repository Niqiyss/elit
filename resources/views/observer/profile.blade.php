        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="relative bg-gradient-to-br from-slate-900 via-violet-950 to-purple-900
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-violet-300 mt-2">
                        View your personal and observer information
                    </p>
            ...
            <div class="bg-white rounded-3xl shadow-lg p-10">
                ...
                <div class="border-t border-gray-200 mt-10 pt-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <input
                                type="date"
                                value="{{ $teacher->observer?->start_date }}"
                                readonly
                                class="w-full rounded-xl border-gray-300 bg-gray-100">
                        ...
                        <div>
                            ...
                            <input
                                type="date"
                                value="{{ $teacher->observer?->end_date }}"
                                readonly
                                class="w-full rounded-xl border-gray-300 bg-gray-100">
                ...
                <div class="border-t border-gray-200 mt-10 pt-8">
                    ...
                    <form method="POST"
                        action="{{ route('observer.profile.password') }}">
