        ...
        * {
        ...
        .observation-summary {
            ...
            grid-template-columns:
                minmax(0, 2fr) minmax(250px, .85fr);
            gap: 22px;
            align-items: start;
            ...
            <div>
                ...
                {{
                    $response->observation_date
                        ? $response->observation_date->format('d/m/Y')
                        : '-'
                }}
            ...
            <div>
                ...
                {{
                    $response->observation_time
                        ? substr(
                            (string) $response->observation_time,
                            0,
                            5
                        )
                        : '-'
