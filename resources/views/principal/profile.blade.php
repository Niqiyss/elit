            ...
            <div class="bg-white rounded-3xl shadow-lg p-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            value="{{ $principal->principal_name ?? '-' }}"
                            readonly
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            value="{{ $principal->school?->school_name ?? '-' }}"
                            readonly
                            class="w-full rounded-xl border-gray-300 bg-gray-100">
                    ...
                    <div>
                        ...
                        <input
                            type="date"
                            value="{{ $principal->appointed_date }}"
                            readonly
                            class="w-full rounded-xl border-gray-300 bg-gray-100">
                ...
                <div class="border-t border-gray-200 mt-10 pt-8">
                    ...
                    <form method="POST" action="{{ route('principal.profile.password') }}">
