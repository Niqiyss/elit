...
class PdpcObservationController extends Controller
{
    ...
    public function create(Request $request, $gn_id)
    {
        ...
        */
        ...
        if ($stage === 'EXTERNAL') {
            ...
            $latestSubmitted = PdpcResponse::where(
                'gn_id',
                $gn_id
            )
                ->where(
            ...
            if (
                ...
                return redirect()
                    ...
                    ->with(
                        'error',
                        'The External Observation has already passed.'
                    );
            }
        }
        ...
        if ($stage === 'POST') {
            ...
            if ($submitted) {
                ...
                return redirect()
                    ...
                    ->with(
                        'error',
                        'The Post Observation has already been submitted.'
                    );
            }
        }
    ...
    public function store(Request $request, $gn_id)
    {
        ...
        DB::transaction(function () use (
            ...
            $calculation = $this->calculateResult(
                $request,
                $form
            );
    ...
    public function edit(
        ...
        $existingScores = PdpcScore::where(
            'responseID',
            $response->responseID
        )
            ->pluck(
    ...
    private function calculateResult(
        ...
        |--------------------------------------------------------------------------
        |
        | $overallTotal is the SAME value as JUMLAH on the view page.
        |
        | Example:
        |
        | 10.00
        ...
        */
        ...
        return [
            ...
            // THIS NOW SAVES 35.59, NOT 88.99
            'percentage' =>
                $overallTotal,
    ...
    // Resolve current evaluator role
