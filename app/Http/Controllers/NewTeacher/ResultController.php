...
class ResultController extends Controller
{
    ...
    public function index()
    {
        ...
        // Latest submitted POST Feedback
        ...
        // Latest submitted EXTERNAL PDPC
        ...
        // Feedback belonging to latest EXTERNAL attempt
        ...
        // Previous submitted EXTERNAL PDPC attempts
    ...
    public function pre($responseID)
    {
        ...
        // Get own submitted PRE response
        ...
        // Get exact PRE form version used
        $form = PreForm::where(
            'formID',
            $response->formID
        )
    ...
    public function pdpc($responseID)
    {
        ...
        $tumsResults =
            $this->calculateStoredTumsResults(
                $form,
                $scores
            );
